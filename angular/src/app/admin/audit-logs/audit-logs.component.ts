...
export class AuditLogsComponent extends AppComponentBase implements AfterViewInit {
    ...
    getAuditLogs(event?: LazyLoadEvent) {
        ...
        this._auditLogService
            .getAuditLogs(
                this._dateTimeService.getStartOfDayForDate(this.dateRange[0]).toDateTime(),
                this._dateTimeService.getEndOfDayForDate(this.dateRange[1]).toDateTime(),
    ...
    exportToExcelAuditLogs(): void {
        ...
        self._auditLogService
            .getAuditLogsToExcel(
                this._dateTimeService.getStartOfDayForDate(self.dateRange[0]).toDateTime(),
                this._dateTimeService.getEndOfDayForDate(self.dateRange[1]).toDateTime(),
    ...
    exportToExcelEntityChanges(): void {
        ...
        self._auditLogService
            .getEntityChangesToExcel(
                this._dateTimeService.getStartOfDayForDate(self.dateRange[0]).toDateTime(),
                self._dateTimeService.getEndOfDayForDate(self.dateRange[1]).toDateTime(),
