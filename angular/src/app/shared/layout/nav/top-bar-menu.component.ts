...
import { Component, Injector, OnInit, ViewEncapsulation, inject, input } from '@angular/core';
import { NavigationEnd, NavigationCancel, Router, RouterLink } from '@angular/router';
