...
using Bit2Sky.Bit2EHR.MultiTenancy.HostDashboard;
...
namespace Bit2Sky.Bit2EHR.Tests.HostDashboard;
...
public class HostDashboardAppService_Tests : AppTestBase
{
    ...
    private void CreatePaidPayment(Bit2EHRDbContext context, SubscriptionPayment subscriptionPayment)
    {
