...
public class Bit2EHRMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
{
    private readonly ILocalizationManager _localizationManager;
    private readonly IEmailSettingsChecker _emailSettingsChecker;

    public Bit2EHRMailKitSmtpBuilder(
    ...
    {
        return _localizationManager.GetString(Bit2EHRConsts.LocalizationSourceName, name);
    }
