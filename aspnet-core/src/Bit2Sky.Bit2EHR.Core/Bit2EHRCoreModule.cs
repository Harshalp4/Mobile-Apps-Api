...
using Bit2Sky.Bit2EHR.Authorization.Impersonation;
using Bit2Sky.Bit2EHR.Authorization.Ldap;
using Bit2Sky.Bit2EHR.Authorization.PasswordlessLogin;
using Bit2Sky.Bit2EHR.Authorization.QrLogin;
...
using Bit2Sky.Bit2EHR.DashboardCustomization.Definitions;
using Bit2Sky.Bit2EHR.Debugging;
using Bit2Sky.Bit2EHR.DynamicEntityProperties;
using Bit2Sky.Bit2EHR.Features;
using Bit2Sky.Bit2EHR.Friendships;
using Bit2Sky.Bit2EHR.Friendships.Cache;
using Bit2Sky.Bit2EHR.Localization;
using Bit2Sky.Bit2EHR.MultiTenancy;
using Bit2Sky.Bit2EHR.Net.Emailing;
using Bit2Sky.Bit2EHR.Notifications;
using Bit2Sky.Bit2EHR.WebHooks;

namespace Bit2Sky.Bit2EHR;

[DependsOn(
    typeof(Bit2EHRCoreSharedModule),
...
public class Bit2EHRCoreModule : AbpModule
{
    public override void PreInitialize()
    {
        ...
        Bit2EHRLocalizationConfigurer.Configure(Configuration.Localization);
        ...
        Configuration.MultiTenancy.IsEnabled = Bit2EHRConsts.MultiTenancyEnabled;
        ...
        Configuration.ReplaceService<IMailKitSmtpBuilder, Bit2EHRMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
        ...
        Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
        {
            Configuration.IocManager.IocContainer.Register(
                Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                         .ImplementedBy<Bit2EHRSmtpEmailSenderConfiguration>()
                         .LifestyleTransient()
            );
        });
    ...
    {
        IocManager.RegisterAssemblyByConvention(typeof(Bit2EHRCoreModule).GetAssembly());
    }
