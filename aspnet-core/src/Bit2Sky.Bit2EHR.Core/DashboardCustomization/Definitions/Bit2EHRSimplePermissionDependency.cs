...
/// </summary>
public class Bit2EHRSimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public Bit2EHRSimplePermissionDependency()
    {
    ...
    public Bit2EHRSimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public Bit2EHRSimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {
