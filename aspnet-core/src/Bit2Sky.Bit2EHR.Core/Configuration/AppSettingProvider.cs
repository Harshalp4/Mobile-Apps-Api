...
using Bit2Sky.Bit2EHR.Authentication;
using Bit2Sky.Bit2EHR.DashboardCustomization;
...
public class AppSettingProvider : SettingProvider
{
    ...
    {
        if (!Bit2EHRConsts.AllowTenantsToChangeEmailSettings)
        {
        ...
        return new[]
        {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        Bit2EHRConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant),
    ...
    private IEnumerable<SettingDefinition> GetDashboardSettings()
    {
        ...
        return new[]
        {
                new SettingDefinition(
                    GetSettingName(
                        Bit2EHRDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        Bit2EHRDashboardCustomizationConsts.Applications.Angular,
                ...
                new SettingDefinition(
                    GetSettingName(
                        Bit2EHRDashboardCustomizationConsts.Applications.React,
    ...
    public Dashboard GetDefaultMvcHostDashboardView()
    {
        ...
        {
            DashboardName = Bit2EHRDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
            Pages = new List<Page>
                {
                    new Page($"Page_{Bit2EHRDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard}_{Bit2EHRDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = Bit2EHRDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = Bit2EHRDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    Bit2EHRDashboardCustomizationConsts.Widgets.Host
    ...
    public Dashboard GetDefaultMvcTenantDashboardView()
    {
        ...
        return new Dashboard
        {
            DashboardName = Bit2EHRDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
            Pages = new List<Page>
                {
                    new Page($"Page_{Bit2EHRDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard}_{Bit2EHRDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = Bit2EHRDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = Bit2EHRDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            {
                                WidgetId =
                                    Bit2EHRDashboardCustomizationConsts.Widgets.Tenant
