...
namespace Bit2Sky.Bit2EHR.Authentication.TwoFactor.Google;

public class GoogleAuthenticatorProvider : Bit2EHRServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
{
    ...
    public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
    {
        ...
        var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Bit2Sky.Bit2EHR", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
