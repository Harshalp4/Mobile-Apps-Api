...
namespace Bit2Sky.Bit2EHR.Core.Base;

public abstract class Bit2EHRQueryBase<TField, TResult> : ITransientDependency
{
    ...
    protected Bit2EHRQueryBase(string fieldName,
