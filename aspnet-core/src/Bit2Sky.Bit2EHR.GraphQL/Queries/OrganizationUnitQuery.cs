...
using Bit2Sky.Bit2EHR.Core.Base;
using Bit2Sky.Bit2EHR.Core.Extensions;
using Bit2Sky.Bit2EHR.Dto;
using Bit2Sky.Bit2EHR.Types;

namespace Bit2Sky.Bit2EHR.Queries;

public class OrganizationUnitQuery : Bit2EHRQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
{
