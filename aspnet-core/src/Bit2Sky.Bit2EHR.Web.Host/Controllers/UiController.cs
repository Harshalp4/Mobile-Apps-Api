...
using Bit2Sky.Bit2EHR.Web.Models.Ui;
using Bit2Sky.Bit2EHR.Web.Session;
using System.Threading.Tasks;

namespace Bit2Sky.Bit2EHR.Web.Controllers;

public class UiController : Bit2EHRControllerBase
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        if (_databaseCheckHelper.Exist(_appConfiguration[$"ConnectionStrings:{Bit2EHRConsts.ConnectionStringName}"]))
        {
