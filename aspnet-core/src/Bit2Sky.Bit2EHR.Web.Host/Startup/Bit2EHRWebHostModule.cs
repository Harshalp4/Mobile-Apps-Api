...
using Bit2Sky.Bit2EHR.Authorization.Users.Password;
...
using Bit2Sky.Bit2EHR.Web.Startup.ExternalLoginInfoProviders;

namespace Bit2Sky.Bit2EHR.Web.Startup;

[DependsOn(
    typeof(Bit2EHRWebCoreModule)
)]
public class Bit2EHRWebHostModule : AbpModule
{
    private readonly IWebHostEnvironment _env;
    private readonly IConfigurationRoot _appConfiguration;

    public Bit2EHRWebHostModule(
    ...
    {
        IocManager.RegisterAssemblyByConvention(typeof(Bit2EHRWebHostModule).GetAssembly());
    }
