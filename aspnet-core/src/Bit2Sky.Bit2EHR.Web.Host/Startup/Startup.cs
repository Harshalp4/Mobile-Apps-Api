...
using Bit2Sky.Bit2EHR.Web.Chat.SignalR;
using Bit2Sky.Bit2EHR.Web.Common;
using Bit2Sky.Bit2EHR.Web.Swagger;
using Stripe;
...
using Bit2Sky.Bit2EHR.Schemas;
using Bit2Sky.Bit2EHR.Web.HealthCheck;
using Owl.reCAPTCHA;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Bit2Sky.Bit2EHR.Web.MultiTenancy;
using Abp.HtmlSanitizer;
using Microsoft.AspNetCore.Authentication.Cookies;
using Bit2Sky.Bit2EHR.Web.Authentication.PasswordlessLogin;
using Bit2Sky.Bit2EHR.Web.OpenIddict;
using Abp.AspNetCore.OpenIddict;
using Bit2Sky.Bit2EHR.Authorization.QrLogin;

namespace Bit2Sky.Bit2EHR.Web.Startup;
...
public class Startup
{
    ...
    public IServiceProvider ConfigureServices(IServiceCollection services)
    {
        ...
        return services.AddAbp<Bit2EHRWebHostModule>(options =>
        {
...
#pragma warning disable CS0162
        if (Bit2EHRConsts.PreventNotExistingTenantSubdomains)
        {
        ...
        if (WebConsts.SwaggerUiEnabled)
        {
            ...
            {
                options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "Bit2EHR API V1");
                options.IndexStream = () => Assembly.GetExecutingAssembly()
                    .GetManifestResourceStream("Bit2Sky.Bit2EHR.Web.wwwroot.swagger.ui.index.html");
    ...
    private void ConfigureSwagger(IServiceCollection services)
    {
        ...
        {
            options.SwaggerDoc("v1", new OpenApiInfo() { Title = "Bit2EHR API", Version = "v1" });
            ...
            if (canShowSummaries)
            {
                ...
                var applicationXml = $"Bit2Sky.Bit2EHR.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"Bit2Sky.Bit2EHR.Web.Core.xml";
