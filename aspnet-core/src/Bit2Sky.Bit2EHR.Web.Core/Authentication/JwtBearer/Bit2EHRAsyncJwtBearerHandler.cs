...
public class Bit2EHRAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
{
    ...
    /// </summary>
    /// <inheritdoc />
    public Bit2EHRAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
