...
/// </summary>
public static class Bit2EHRJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, Bit2EHRAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
