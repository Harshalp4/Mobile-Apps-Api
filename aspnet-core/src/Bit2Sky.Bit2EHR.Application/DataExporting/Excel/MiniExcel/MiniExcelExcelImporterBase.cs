...
namespace Bit2Sky.Bit2EHR.DataExporting.Excel.MiniExcel;

public abstract class MiniExcelExcelImporterBase<TEntity>(ILocalizationManager localizationManager)
{
    private readonly ILocalizationSource _localizationSource = localizationManager.GetSource(Bit2EHRConsts.LocalizationSourceName);
