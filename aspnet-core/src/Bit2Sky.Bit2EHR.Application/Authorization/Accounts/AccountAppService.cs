...
using Bit2Sky.Bit2EHR.Authentication.PasswordlessLogin;
using Bit2Sky.Bit2EHR.Authorization.PasswordlessLogin;

namespace Bit2Sky.Bit2EHR.Authorization.Accounts;

public class AccountAppService : Bit2EHRAppServiceBase, IAccountAppService
{
    ...
    private async Task SendSmsPasswordlessCode(string phoneNumber)
    {
        ...
        var message = string.Format(L("PasswordlessLogin_SmsMessage", Bit2EHRConsts.ProductName, code));
