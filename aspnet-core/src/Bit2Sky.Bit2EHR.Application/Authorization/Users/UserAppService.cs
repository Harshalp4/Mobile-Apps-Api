...
using Bit2Sky.Bit2EHR.Authorization.Permissions;
...
using Bit2Sky.Bit2EHR.Authorization.Users.Exporting;
using Bit2Sky.Bit2EHR.Dto;
using Bit2Sky.Bit2EHR.Exporting;
...
public class UserAppService : Bit2EHRAppServiceBase, IUserAppService
{
