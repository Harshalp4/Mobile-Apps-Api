...
using Bit2Sky.Bit2EHR.Authorization.Users.Profile.Cache;
...
using Bit2Sky.Bit2EHR.Gdpr;
using Bit2Sky.Bit2EHR.Graphics;
using Bit2Sky.Bit2EHR.Net.Sms;
using Bit2Sky.Bit2EHR.Security;
using Bit2Sky.Bit2EHR.Storage;
using Bit2Sky.Bit2EHR.Timing;
...
[AbpAuthorize]
public class ProfileAppService : Bit2EHRAppServiceBase, IProfileAppService
{
    ...
    public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
    {
        ...
        userProfileEditDto.QrCodeSetupImageUrl = userProfileEditDto.IsGoogleAuthenticatorEnabled
            ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Bit2Sky.Bit2EHR",
