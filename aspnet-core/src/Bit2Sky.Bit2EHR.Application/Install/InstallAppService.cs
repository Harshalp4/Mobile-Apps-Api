...
[AbpAllowAnonymous]
[DisableAuditing]
public class InstallAppService : Bit2EHRAppServiceBase, IInstallAppService
{
    private readonly AbpZeroDbMigrator<Bit2EHRDbContext> _migrator;
    ...
    {
        var connectionString = _appConfiguration[$"ConnectionStrings:{Bit2EHRConsts.ConnectionStringName}"];
    ...
    {
        EditAppSettingsjson($"ConnectionStrings:{Bit2EHRConsts.ConnectionStringName}", constring);
    }
