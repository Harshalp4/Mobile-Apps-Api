...
using Bit2Sky.Bit2EHR.Auditing.Exporting;
...
using EntityHistoryHelper = Bit2Sky.Bit2EHR.EntityHistory.EntityHistoryHelper;

namespace Bit2Sky.Bit2EHR.Auditing;

[DisableAuditing]
[AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
public class AuditLogAppService : Bit2EHRAppServiceBase, IAuditLogAppService
{
