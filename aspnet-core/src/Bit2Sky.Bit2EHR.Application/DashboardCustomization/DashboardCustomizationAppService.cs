...
using Bit2Sky.Bit2EHR.DashboardCustomization.Dto;

namespace Bit2Sky.Bit2EHR.DashboardCustomization;

[AbpAuthorize]
public class DashboardCustomizationAppService : Bit2EHRAppServiceBase, IDashboardCustomizationAppService
{
