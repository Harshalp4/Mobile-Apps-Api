...
using Bit2Sky.Bit2EHR.DemoUiComponents.Dto;

namespace Bit2Sky.Bit2EHR.DemoUiComponents;

[AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
public class DemoUiComponentsAppService : Bit2EHRAppServiceBase, IDemoUiComponentsAppService
{
