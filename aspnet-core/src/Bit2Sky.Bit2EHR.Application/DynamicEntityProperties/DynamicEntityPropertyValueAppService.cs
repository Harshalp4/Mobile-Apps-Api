...
using Bit2Sky.Bit2EHR.DynamicEntityPropertyValues.Dto;
...
public class DynamicEntityPropertyValueAppService : Bit2EHRAppServiceBase, IDynamicEntityPropertyValueAppService
{
