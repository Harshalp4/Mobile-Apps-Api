...
using Bit2Sky.Bit2EHR.MultiTenancy.Payments.Paypal;
using Bit2Sky.Bit2EHR.MultiTenancy.Payments.PayPal;
using Bit2Sky.Bit2EHR.MultiTenancy.Payments.PayPal.Dto;

namespace Bit2Sky.Bit2EHR.MultiTenancy.Payments;

public class PayPalPaymentAppService : Bit2EHRAppServiceBase, IPayPalPaymentAppService
{
