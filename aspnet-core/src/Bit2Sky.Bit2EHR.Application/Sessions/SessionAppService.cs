...
public class SessionAppService : Bit2EHRAppServiceBase, ISessionAppService
{
        ...
        return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = Bit2EHRConsts.Currency,
                    CurrencySign = Bit2EHRConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = Bit2EHRConsts.AllowTenantsToChangeEmailSettings,
