...
using Bit2Sky.Bit2EHR.EntityFrameworkCore.Repositories;

namespace Bit2Sky.Bit2EHR.Organizations;

public class UserOrganizationUnitRepository : Bit2EHRRepositoryBase<UserOrganizationUnit, long>,
    IUserOrganizationUnitRepository
{
    public UserOrganizationUnitRepository(IDbContextProvider<Bit2EHRDbContext> dbContextProvider)
