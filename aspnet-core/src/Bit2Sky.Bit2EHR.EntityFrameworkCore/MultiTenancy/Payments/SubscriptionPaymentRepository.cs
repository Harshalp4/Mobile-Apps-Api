...
public class SubscriptionPaymentRepository : Bit2EHRRepositoryBase<SubscriptionPayment, long>,
    ISubscriptionPaymentRepository
{
    public SubscriptionPaymentRepository(IDbContextProvider<Bit2EHRDbContext> dbContextProvider)
