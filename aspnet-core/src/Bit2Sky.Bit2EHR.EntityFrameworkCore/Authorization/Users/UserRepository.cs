...
public class UserRepository : Bit2EHRRepositoryBase<User, long>, IUserRepository
{
    public UserRepository(IDbContextProvider<Bit2EHRDbContext> dbContextProvider)
