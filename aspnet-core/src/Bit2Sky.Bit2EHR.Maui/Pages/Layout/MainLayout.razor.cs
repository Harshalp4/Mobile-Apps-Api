...
using Bit2Sky.Bit2EHR.Maui.Core.Helpers;
using Bit2Sky.Bit2EHR.Maui.Core.Localization;
using Bit2Sky.Bit2EHR.Maui.Services.Account;
using Bit2Sky.Bit2EHR.Maui.Services.Navigation;
using Bit2Sky.Bit2EHR.Maui.Services.Tenants;
using Bit2Sky.Bit2EHR.Maui.Services.UI;

#if ANDROID
using Bit2Sky.Bit2EHR.Maui.Core.Platforms.Android.HttpClient;
#endif
#if IOS
using Bit2Sky.Bit2EHR.Maui.Core.Platforms.iOS.HttpClient;
#endif

namespace Bit2Sky.Bit2EHR.Maui.Pages.Layout;
