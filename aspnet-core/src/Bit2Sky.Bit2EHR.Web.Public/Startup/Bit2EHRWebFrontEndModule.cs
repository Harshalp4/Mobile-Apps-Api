...
public class Bit2EHRWebFrontEndModule : AbpModule
{
    private readonly IConfigurationRoot _appConfiguration;

    public Bit2EHRWebFrontEndModule(IWebHostEnvironment env, Bit2EHREntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
    {
    ...
    {
        IocManager.RegisterAssemblyByConvention(typeof(Bit2EHRWebFrontEndModule).GetAssembly());
    }
}
