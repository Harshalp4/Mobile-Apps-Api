...
using Bit2Sky.Bit2EHR.Web.Public.Startup;
using Bit2Sky.Bit2EHR.Web.Session;
using System.Linq;
using System.Threading.Tasks;

namespace Bit2Sky.Bit2EHR.Web.Public.Views.Shared.Components.Header;

public class HeaderViewComponent : Bit2EHRViewComponent
{
