...
$webMvcFolder = Join-Path $slnFolder "src/Bit2Sky.Bit2EHR.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/Bit2Sky.Bit2EHR.Web.Public"
...
dotnet restore Bit2Sky.Bit2EHR.Web.sln
